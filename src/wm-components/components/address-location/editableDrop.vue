<template>
    <div :class="classes" @click="toggleMenu" v-clickoutside="clickoutsideHandle">
        <i-input class="wm-drop-input" type="text" v-model="query" :placeholder="placeholder" :disabled="disabled" @on-blur="blurHandle" @input="inputHandle" @on-change="changeHandle"></i-input>
