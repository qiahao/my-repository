<template lang="html">
    <div>
        ...
        <slide-modal v-model="slideModal" style="width: 960px;">
            <div slot="head">车次详情
                <span>
                    <i-button type="primary" @click="addMain">保存</i-button>
                </span>
            </div>
            <div slot="default" style="width:920px">   
                <i-form  ref="mainData" :model="mainData" :rules="ruleObj"  :label-width="115">
                                ...
                                <Row>
                                    ...
                                    <Col span="4">
                                        <Form-item label="分段名称："  :label-width="85">
                                            <i-input  size="small" v-model="sectionInfo.section_name"  placeholder="分段" style="width:120px"></i-input>
                                        </Form-item> 
                                    </Col>
                                    <Col span="8">
                                        <Form-item  :label-width="0">
                                            <i-button type="primary" size="small" @click="addSection">添加分段</i-button>
                                        </Form-item>
                                    </Col>
                                </Row>
                                <Row>
                                    <Col span="24">
                                        <Form-item label="分段列表："  :label-width="85">
                                            ...
                                            <ul  v-show="columns.length>0" class="clearfix section-list">
                                                <li v-for="(item,index) in columns" :key="index"><span>{{item}}</span><span  @click="removeSection(item)"><Icon class="ml5" type="close-circled"></Icon></span></li>
                                            </ul>
                                        </Form-item>
                                    </Col>
                                </Row>
                    ...
                    <div class="form-table cf-all mt10">
                        <div class="form-table-row cragos-list  cf-all text-center">
                            <Form-item v-for="(item,index) in newColumns"  class="form-item" style='text-align:center' :key="index">
                                {{item}}
                            </Form-item>
                        </div>
                        <div class="form-table-row cragos-list  cf-all text-center">
                            <Form-item  :label-width="0" class="form-item">
                                <i-input  placeholder="始发地"></i-input>
                            </Form-item>
                            <Form-item class="form-item"  > 
                                <i-input  placeholder="提货费"></i-input>
                            </Form-item>
                            <Form-item class="form-item"  >
                                <i-input  placeholder="目的地"></i-input>
                            </Form-item>
                            <Form-item  class="form-item" > 
                                <i-input  placeholder="送货费"></i-input>
                            </Form-item>
                            <Form-item  class="form-item" > 
                                <i-input  placeholder="最低收费"></i-input>
                            </Form-item>
                            <Form-item  class="form-item" > 
                                <i-input  placeholder="小时"></i-input>
                            </Form-item>
                        </div>
                    </div>
                </i-form>
