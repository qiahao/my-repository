    ...
    <div>
        <div class='contain-head' >
            <div v-show='!hasSelect'>
                ...
                -->
                <i-button type="primary" @click="createdProject">添加成员</i-button>
            </div>
        </div>
...
<script>
    import tripDetailModal from '@/components/linerAccount/v2/detail.vue'
    import tableMixin from '@/mixins/tableMixin'
    import { getLinerList} from '@/api/src/linerAccount'
    import { utilCookie} from '@/utils/util'
    import { mapState } from 'vuex'
    import topFilterSelect from './top-filter-select.vue'

    export default{
        name:'linerAccountV2List',
        data:function(){
             return {
                conditionList:[
                    {
                ...
                columns: [
                    ...
                    {title: '企业名称',key: 'liner_name'}, 
                    {title: '所在地',key: 'liner_area'}, 
